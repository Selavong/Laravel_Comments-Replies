    ...
    <div class="sidebar">
        ...
        <ul class="sidebar__nav">
            <li class="sidebar__nav-item">
                <a href="{{ route('admin') }}" class="sidebar__nav-link sidebar__nav-link--active">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.movie') }}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.actor') }}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
                            d="M10,13H3a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,10,13ZM9,20H4V15H9ZM21,2H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,21,2ZM20,9H15V4h5Zm1,4H14a1,1,0,0,0-1,1v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V14A1,1,0,0,0,21,13Zm-1,7H15V15h5ZM10,2H3A1,1,0,0,0,2,3v7a1,1,0,0,0,1,1h7a1,1,0,0,0,1-1V3A1,1,0,0,0,10,2ZM9,9H4V4H9Z" />
                    </svg>
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.director') }}" class="sidebar__nav-link"><svg
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.users') }}" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.comment') }}" class="sidebar__nav-link"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="{{ route('admin.review') }}" class="sidebar__nav-link"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
