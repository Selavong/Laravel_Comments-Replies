...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="'main/image/png" href="icon/favicon-32x32.png" sizes="32x32">
                    ...
                    <div class="header__content">
                        ...
                        <ul class="header__nav">
                            <li class="header__nav-item">
                                <a class="header__nav-link" href="{{ route('home') }}" role="button"
                                    ...
                                    aria-expanded="false">Home <svg width="4" height="4" viewBox="0 0 4 4"
                                ...
                                <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    {{-- <li class="dropdown-submenu">
                                        <a class="dropdown-item" href="#" role="button" id="dropdownMenuSub"
                                            ...
                                            dropdown <svg width="4" height="4" viewBox="0 0 4 4" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z" />
                                            </svg></a>
                            ...
                            <li class="header__nav-item">
                                <a class="header__nav-link" href="{{ route('pricing') }}">Pricing plans</a>
                            </li>
                            <li class="header__nav-item">
                                <a class="header__nav-link header__nav-link--live" href="{{ route('live') }}">LIVE<svg
                            ...
                            <li class="header__nav-item">
                                ...
                                <ul class="dropdown-menu header__nav-menu header__nav-menu--scroll"
                                    ...
                                    <li><a href="{{ route('admin') }}" target="_blank">Admin pages</a></li>
                        ...
                        <div class="header__actions">
                            <form action="#" class="header__form">
                                ...
                                <button class="header__form-btn" type="button"><svg
                            ...
                            @else{
                                {{-- <form class="header__user" action="{{ route('logout') }}" method="POST"> --}}
