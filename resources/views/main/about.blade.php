            ...
            <div class="row row--grid">
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">It to make a type specimen book. It has survived not only five centuries, but
            ...
            <div class="row row--grid">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="feature">
                        ...
                        <h3 class="feature__title">Choose your Plan</h3>
                        <p class="feature__text">t to make a type specimen book. It has survived not only five centuries,
