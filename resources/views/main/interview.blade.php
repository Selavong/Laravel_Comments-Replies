                ...
                <div class="row">
                    <div class="col-12 col-xl-8">
                        ...
                        <div class="article__content">
                            <a href="category.html" class="article__category">Documentary</a>
                            ...
                            <span class="article__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                ...
                                </svg> 09.03.2021, 16:37</span>

                            <h1>Winners Bracket Final Interview - Most Emotional Esports Interview</h1>

                            <iframe src="https://www.youtube.com/embed/isbXIzKPeeY"
                            ...
                            <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default
                                model text, and a search for 'lorem ipsum' will <b>uncover many</b> web sites still in their
                            ...
                            <blockquote>If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
                            ...
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                suffered alteration in some form, by injected humour, or randomised words which don't look
                                even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be
                                sure there isn't anything embarrassing hidden in the middle of text. <a
                                    href="#">Link</a> the Lorem Ipsum generators on the Internet tend to repeat
                        ...
                        <div class="comments">
                            ...
                            <ul class="comments__list">
                                <li class="comments__item">
                                    ...
                                    <div class="comments__actions">
                                        <div class="comments__rate">
                                            <button type="button"><svg width="22" height="22" viewBox="0 0 22 22"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M11 7.3273V14.6537" stroke-width="1.5" stroke-linecap="round"
                                            ...
                                            <button type="button">7 <svg width="22" height="22" viewBox="0 0 22 22"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M14.6667 10.9905H7.33333" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <button type="button"><svg xmlns='http://www.w3.org/2000/svg' width='512'
                                ...
                                <li class="comments__item comments__item--quote">
                                    ...
                                    <p class="comments__text"><span>There are many variations of passages of Lorem Ipsum
                                            available, but the majority have suffered alteration in some form, by injected
                                            humour, or randomised words which don't look even slightly believable.</span>It
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <form action="#" class="subscribe">
                                        ...
                                        <p class="subscribe__text">All the Lorem Ipsum generators on the Internet tend to
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 col-xl-12">
                                    <div class="interview">
                                        ...
                                        <h3 class="interview__title"><a href="interview.html">What Was Ben Affleck
                                                Planning for His Unmade 'Batman' Film?</a></h3>
                                    </div>
                                </div>
