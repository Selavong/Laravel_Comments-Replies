        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    ...
                    <p class="section__text">It is a long fact that a reader will be distracted by the readable content of a
                        page when looking at its layout</p>
                    <ul class="contacts__list">
                        <li><a href="tel:+18092345678">+1 809 234-56-78</a></li>
                        <li><a href="mailto:support@flixtv.template">support@flixtv.template</a></li>
                    </ul>
                    <div class="contacts__social">
                        ...
                        <a href="https://www.instagram.com/volkov_des1gn/" target="_blank"><svg width="30"
                                ...
                                <path
                                    d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
                                    fill="white" />
                                <mask id="mask01" maskUnits="userSpaceOnUse" x="0" y="0" width="30" height="30">
