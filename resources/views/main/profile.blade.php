                    ...
                    <div class="profile">
                        <div class="profile__user">
                            <div class="profile__avatar">
                                {{-- fix the code --}}
                                <img src="{{ Auth::user()->profile ? url('profile-photos/' . Auth::user()->profile) : url('profile-photos/no-profile.jpg') }}" alt="img" id="update_profile_pic">
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="dashbox">
                                <div class="dashbox__title">
                                    ...
                                    <div class="dashbox__wrap">
                                        <a class="dashbox__refresh" href="#"><svg
                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                <path
                                                    d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z">
                                                </path>
                ...
                <div class="tab-pane fade" id="tab-2" role="tabpanel">
                    ...
                    <div class="row row--grid">
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/1.png" alt="">
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/2.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/3.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/4.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/5.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/6.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/7.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/8.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/9.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/10.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/11.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/12.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/13.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/14.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/15.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/16.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/17.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card card--favorites">
                                <a href="details.html" class="card__cover">
                                    <img src="main/img/card/18.png" alt="">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M11 1C16.5228 1 21 5.47716 21 11C21 16.5228 16.5228 21 11 21C5.47716 21 1 16.5228 1 11C1 5.47716 5.47716 1 11 1Z"
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <form action="{{ route('user.profile.update') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                    <div class="sign__group">
                                                        ...
                                                        <input id="username" type="text" name="username"
                                                            class="sign__input" value="{{ Auth::user()->name }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                    <div class="sign__group">
                                                        ...
                                                        <input id="email" type="text" name="email"
                                                            class="sign__input" value="{{ Auth::user()->email }}"
                                                            disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                    <div class="sign__group">
                                                        <label class="sign__label" for="subscription">Subscription :
                                                            Basic</label>
                                                        {{-- <select class="js-example-basic-single ml-3"
                                                            style="background-clip: black" id="subscription">
                                                            <option value="Basic" style="background-clip: black">Basic
                                                            </option>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                    <div class="sign__group">
                                                        <label class="sign__label" for="role" name="role">Role :
                                                        ...
                                                        {{-- <select class="js-example-basic-single ml-3" name="role"
                                                            id="rights">
                                                ...
                                                <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                    <div class="sign__group">
                                                        ...
                                                        <input id="confirmpass" type="password"
                                                            name="new_password_confirmation" class="sign__input">
                                                    </div>
                                                </div>
