                        ...
                        <div class="section__live owl-carousel" id="livetv">
                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/1.jpg" alt="">
                                ...
                                <div class="live__avatar">
                                    <img src="main/img/avatar.svg" alt="">
                                </div>
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">RERUN: FURIA vs. Natus Vincere [Nuke] Map 2</a></h3>
                            </div>

                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/2.jpg" alt="">
                                    <span class="live__status">live</span>
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">Wings Up vs Lynn Vision | (0-0) BO3</a></h3>
                            </div>

                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/3.jpg" alt="">
                                    <span class="live__status">live</span>
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">RERUN: Seither vs. RazerBlader - DH Masters: Winter 2020 -
                                        Playoffs - OCE</a></h3>
                            </div>

                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/4.jpg" alt="">
                                    <span class="live__status">live</span>
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">Best of 2020: Top Trending Moments</a></h3>
                            </div>

                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/5.jpg" alt="">
                                    <span class="live__status">live</span>
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">How Movies and TV Shaped Our Perception of HIV/AIDS</a></h3>
                            </div>

                            <div class="live">
                                <a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
                                    <img src="main/img/live/6.jpg" alt="">
                                    <span class="live__status">live</span>
                                    <span class="live__value">588 viewers</span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="section__text">Live tournaments, match highlights, and your favorite pro players all in one
                        place</p>
                </div>
            </div>
            ...
            <div class="row row--grid">
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/1.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/2.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/3.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/4.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/5.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/6.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/7.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                    <a href="category.html" class="category">
                        <div class="category__cover">
                            <img src="main/img/category/8.jpg" alt="">
                        </div>
                    ...
                    <div class="section__carousel-wrap">
                        <div class="section__live owl-carousel" id="recommended">
                            <div class="live">
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">What Was Ben Affleck Planning for His Unmade 'Batman' Film?</a>
                                </h3>
                            </div>
                            ...
                            <div class="live">
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">A Guide to the Work of Ryan Murphy</a></h3>
                            </div>
                            ...
                            <div class="live">
                                ...
                                <h3 class="live__title"><a href="http://www.youtube.com/watch?v=0O2aH4XLbto"
                                        class="open-video">Gugu Mbatha-Raw Shares the Films That Give Her Hope</a></h3>
                            </div>
                        ...
                        <button class="section__nav section__nav--live section__nav--prev" data-nav="#recommended"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.25 7.72559L16.25 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                        ...
                        <button class="section__nav section__nav--live section__nav--next" data-nav="#recommended"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.75 7.72559L0.75 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section__carousel-wrap">
                        ...
                        <button class="section__nav section__nav--live section__nav--prev" data-nav="#hype"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.25 7.72559L16.25 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                        ...
                        <button class="section__nav section__nav--live section__nav--next" data-nav="#hype"
                            type="button"><svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.75 7.72559L0.75 7.72559" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                ...
                <div class="col-12">
                    <div class="partners owl-carousel">
                        <a href="#" class="partners__img">
                            <img src="main/img/partners/3docean-light-background.png" alt="">
                        </a>

                        <a href="#" class="partners__img">
                            <img src="main/img/partners/activeden-light-background.png" alt="">
                        </a>

                        <a href="#" class="partners__img">
                            <img src="main/img/partners/audiojungle-light-background.png" alt="">
                        </a>

                        <a href="#" class="partners__img">
                            <img src="main/img/partners/codecanyon-light-background.png" alt="">
                        </a>

                        <a href="#" class="partners__img">
                            <img src="main/img/partners/photodune-light-background.png" alt="">
                        </a>

                        <a href="#" class="partners__img">
                            <img src="main/img/partners/themeforest-light-background.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
